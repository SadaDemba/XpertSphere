...
// numérique), et ce champ est purement déclaratif/d'affichage. Un enum numérique casserait
// silencieusement l'affichage (la valeur reçue "XOF" ne correspondrait à aucune clé numérique de
// l'enum).
