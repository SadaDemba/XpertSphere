...
public interface IApplicationStatusHistoryService
{
    ...
    Task<ServiceResult<ApplicationStatusHistoryDto>> CreateAsync(CreateApplicationStatusHistoryDto dto,
        Guid updatedByUserId);

    Task<ServiceResult<ApplicationStatusHistoryDto>> UpdateAsync(Guid id, UpdateApplicationStatusHistoryDto dto,
        Guid updatedByUserId);
