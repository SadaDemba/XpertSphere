...
public class Training : AuditableEntity
{
    ...
    [MaxLength(100)] public string School { get; set; } = string.Empty;

    [MaxLength(40)] public string? Period { get; set; } = string.Empty;

    [MaxLength(150)] public string Field { get; set; } = string.Empty;

    [MaxLength(60)] public string Level { get; set; } = string.Empty;

    [NotMapped] [JsonIgnore] public virtual User User { get; set; } = null!;
}