        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_Country = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, defaultValue: "France"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsentWithdrawnAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DataRetentionUntil = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[OrganizationId] IS NOT NULL AND [EmployeeId] IS NOT NULL");
